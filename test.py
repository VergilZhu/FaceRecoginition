...
folderPath = "~/Files/Git/FaceRecoginition/"
...
hidden_layer = addLayer(xs, 1, 5, activity_function=tf.nn.sigmoid)
...
print('---------------')
print(sess.run(output_layer, feed_dict={xs:[[-2,0],[4,-1],[4,0],[4,1],[4,2],[4,3],[4,4],[4,5],[4,10],[10,0]]}))	